...
var setGlobalValue = function (name, v) {
    if (!light.globalValueMap) {
        light.globalValueMap = {};
    }
    if (v !== undefined && v !== null) {
        light.globalValueMap[name] = v;
    }
    console.error('set light.globalValueMap', JSON.stringify(light.globalValueMap));
};
var getGlobalValue = function (name) {
    if (!light.globalValueMap) {
        return null;
    }
    return light.globalValueMap[name];
};
...
var PostEffectNode = /** @class */ (function (_super) {
    ...
    function PostEffectNode() {
        ...
        _this.fastNumPercentageInput = 0;
        _this.seedNumInput = 0;
        _this.clusterDistanceInput = 0;
        _this.clusterMaxSizeInput = 0;
        _this.shakeDisPlacementInput = 0;
        _this.sleepTimeInput = 0;
        _this.switchEnvironmentInput = 0;
    ...
    PostEffectNode.prototype.Run = function () {
        ...
        if (postEffect) {
            if (postEffect.getEffectJson()) {
                ...
                json.fastNumPercentage = this.fastNumPercentageInput > 0 ? this.fastNumPercentageInput : json.fastNumPercentage;
                json.seedNum = this.seedNumInput > 0 ? this.seedNumInput : json.seedNum;
                json.clusterDistance = this.clusterDistanceInput > 0 ? this.clusterDistanceInput : json.clusterDistance;
                json.clusterMaxSize = this.clusterMaxSizeInput > 0 ? this.clusterMaxSizeInput : json.clusterMaxSize;
                json.shakeDisPlacement = this.shakeDisPlacementInput > 0 ? this.shakeDisPlacementInput : json.shakeDisPlacement;
                json.sleepTime = this.sleepTimeInput > 0 ? this.sleepTimeInput : json.sleepTime;
                json.switchEnvironment = false;
...
var GlobalValue = /** @class */ (function (_super) {
    ...
    GlobalValue.prototype.Run = function () {
        if (GlobalValue.isNotNull(this.inValue)) {
            setGlobalValue(this._propName, this.inValue);
        }
        this.Next();
    };
    GlobalValue.prototype.Next = function () { };
    Object.defineProperty(GlobalValue.prototype, "outValue", {
        get: function () {
            return getGlobalValue(this._propName);
        },
        enumerable: false,
        configurable: true
    });
    GlobalValue.isNotNull = function (v) {
